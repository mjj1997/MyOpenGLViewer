...
// configuration step. It creates a namespace called `MyOpenGLViewer`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", MyOpenGLViewer::cmake::project_name, MyOpenGLViewer::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", MyOpenGLViewer::cmake::project_version);
      return EXIT_SUCCESS;
    }
